    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/arul1312/webcalc-java.git'
            }
        }
       ...
       //             sh 'mvn sonar:sonar'
        ...
        stage('Deploy to Tomcat') {
            steps {
                ...
                deploy adapters: [tomcat8(credentialsId: 'tomcat', path: '', url: 'http://192.168.132.130:8081/')], contextPath: null, war: '**/*.war'
            }
        }
